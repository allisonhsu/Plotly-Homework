...
function metadata(fileterdmetadata){
    Object.entries(fileterdmetadata).forEach(function([k,v]){
...
// 1. Use the D3 library to read in `samples.json`.
    d3.json(file).then(function(data){
        ...
        var filteredData = data.samples.filter(d => d.id === inputValue);
        var fileterdmetadata = data.metadata.filter(n => n.id.toString() === inputValue);
        console.log(filteredData);
        console.log(fileterdmetadata);
        chart(filteredData);
